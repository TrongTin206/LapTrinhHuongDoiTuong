...
bằng một ngôn ngữ lập trình hướng đối tượng, tự học ngôn ngữ lập trình hướng đối tượng khác và
các thư viện lập trình kèm theo.
...
- Thiết kế, cài đặt lớp đối tượng phù hợp yêu cầu của bài toán. Làm việc với các đối tượng của lớp;
- Vận dụng kỹ thuật thừa kế, cơ chế đa hình, giao diện (interface) trong cài đặt chương trình;
- Phát triển ứng dụng giao tiếp đồ họa người dùng (GUI).
